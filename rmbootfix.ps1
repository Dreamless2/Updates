...
$oscdRealPath = "$rmbootPath\oscdimg-amd64"
...
$oscdimg = "$oscdFullPath\oscdimg.exe"
$etfsboot = "$oscdFullPath\etfsboot.com"
$efisys_noprompt = "$oscdFullPath\efisys_noprompt.bin"
