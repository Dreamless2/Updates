...
function Update-Winget {
    ...
    $PackagePath = Join-Path $TempDir $FileName
...
function Install-Winget {
    ...
    Update-Winget -URL "https://aka.ms/getwinget" -FileName "Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle"
    Update-Winget -URL "https://aka.ms/Microsoft.VCLibs.x64.14.00.Desktop.appx" -FileName "Microsoft.VCLibs.x64.14.00.Desktop.appx"
    Update-Winget -URL "https://github.com/microsoft/microsoft-ui-xaml/releases/download/v2.8.6/Microsoft.UI.Xaml.2.8.x64.appx" -FileName "Microsoft.UI.Xaml.2.8.x64.appx"
...
function Install-Delphi12 {
    ...
    DS_ExpandArchive -SourceFile $componentsPath -DestinationPath $env:HOMEDRIVE -Overwrite $true
